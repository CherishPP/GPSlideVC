...
@protocol GPSwitchViewDelegate;
@interface GPSwitchView : UIView<UIScrollViewDelegate>
{
    ...
    __weak id<GPSwitchViewDelegate> _switchViewDelegate;
}
...
@property (nonatomic, weak) IBOutlet id<GPSwitchViewDelegate> switchViewDelegate;
...
@protocol GPSwitchViewDelegate <NSObject>
 ...
 * @result
 */
- (void)slideSwitchView:(GPSwitchView *)view panRightEdge:(UIPanGestureRecognizer*) panParam;
